	...
	<div id="choose">
		...
		<table id="cardTitle">
			<tr class="trHeight">
				...
				<td><textarea rows="2" cols="30" id="title" name="c_title"></textarea></td>
			</tr>
			<tr class="trHeight">	
				<th class="inputText"><p><label for="info">학습세트 소개</label></p></th>
				<td><textarea rows="3" cols="50" id="info" name="c_content"></textarea></td>
			</tr>	
		</table>
	</div><!-- end : choose -->
...
<hr class="dashed">
	...
	<div id="insertCard">
		<%@include file="customCardRow.jsp"%>
	</div>
</form>	
</body>
</html>